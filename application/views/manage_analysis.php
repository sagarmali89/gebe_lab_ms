...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $(".generate-table-element").change(function () {
            if ($('#consumer').val() != "" && $('#consumer').val() != null && $('#consumer').val() != 0) {
    ...
    function saveChange(thatEle, rowno) {
        ...
        if ((eleNameAsArray == "date[]" || eleNameAsArray == "time[]") && (date != "" && time != "" && consumer != "")) {
            var postData = {
                issingle: true,
    ...
    function deleteRow(thatbtn) {
        ...
        if (hasRecord && deleteWhereData.date != null && deleteWhereData.time != null) {
            $.post('<?php echo base_url('Water_Analysis/deleteAnalysisRecord'); ?>', deleteWhereData, function (response) {
    ...
    function appendNewRow(thatbtn) {
        ...
        var newRowHtml = '<tr><td><span class="btn btn-xs btn-success" onclick="appendNewRow(this)"><i class="fa fa-plus"></i></span><span class="btn btn-xs btn-danger" onclick="deleteRow(this)"><i class="fa fa-trash"></i></span></td><td><input class="datepicker" type="text" name="date[]" value=""/></td><td><input type="text" name="time[]" class="timepicker"/></td><td><select name="status[]" disabled><option value="" selected disabled></option><option value="Closed">Closed</option><option value="No Water">No Water</option><option value="Rain">Rain</option></select></td><td><input class="digit" type="text" name="temp[]" disabled/></td><td><input class="digit" type="text" name="ph[]" disabled/></td><td><input class="digit" type="text" name="cond[]" disabled/></td><td><input class="digit" type="text" name="tds[]" disabled readonly/></td><td><input class="digit" type="text" name="chload[]" disabled/></td><td><input class="digit" type="text" name="talk[]" disabled/></td><td><input class="digit" type="text" name="cahard[]" disabled/></td><td><input class="digit" type="text" name="iron[]" disabled/></td><td><input class="digit" type="text" name="silica[]" disabled/></td><td><input class="digit" type="text" name="alum[]" disabled/></td><td><input class="digit" type="text" name="turb[]" disabled/></td><td><input class="digit" type="text" name="chlone[]" disabled/></td><td><input class="digit" type="text" name="lsi[]" disabled/></td><td><input class="digit" type="text" name="color[]" disabled/></td><td><input class="digit" type="text" name="lead[]" disabled/></td><td><input class="digit" type="text" name="tc[]" disabled/></td><td><input class="digit" type="text" name="ec[]" disabled/></td><td><input class="digit" type="text" name="ent[]" disabled/></td><td><input class="digit" type="text" name="hpc[]" disabled/></td><td><input class="digit" type="text" name="clost[]" disabled/></td><td><input type="text" name="leg[]" disabled/></td></tr>';
