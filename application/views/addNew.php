<?php if (!isset($formModalRequired)): ?>
    ...
    <section class="content">
        <div class="row">
            ...
            <?php endif ?>
                ...
                <?php if (isset($formModalRequired)): ?>
                <div id="fk_ei_operator-form-modal" class="modal fade" role="dialog">
                ...
                <div class="modal-body">
                    ...
                    <?php 
                        if (isset($formModalRequired)) {
                            echo '<form role="form" id="addUser" action="'.base_url().'electrical_issue/addNewOperator" method="post" role="form">';
                        } else {
                            echo '<form role="form" id="addUser" action="'.base_url().'addNewUser" method="post" role="form">';
                        } 
                    ?>
                        <div class="box-body">
                            <div class="row">
