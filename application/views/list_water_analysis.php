...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#analysis-records').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '<?php echo base_url('Water_Analysis/getRecordsForDataTable') ?>'
            },
            scrollY: "300px",
            scrollX: true,
            scrollCollapse: true,
    ...
    $('#filter-form select, #filter-form input').change(function () {
        ...
        $.post("<?php echo base_url(); ?>Water_Analysis/updateFilterSession", filterdata, function () {
